<template>
  <div>
    <h2>第1章 グッドEO</h2>
    <p>
      DRの最初のステップは、「グッド」なEOを見つけることです。
      グッドなEOとは、どのようなものだと思いますか？
    ...
    <div class="text-center">
      <nuxt-link to="/fmc/domino-first">はじめに</nuxt-link> | <nuxt-link to="/fmc/domino-reduction">目次</nuxt-link> | <nuxt-link to="/fmc/domino-chapter2-1">コーナー反転とグッドエッジ</nuxt-link>
    </div>
  </div>
</template>
