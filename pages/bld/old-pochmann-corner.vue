...
<b-list-group horizontal>
  <b-list-group-item><div id="pochmann1"></div></b-list-group-item>
  <b-list-group-item>F R U' R' U' R U R' F' R U R' U' R' F R F'</b-list-group-item>
</b-list-group>
...
<b-list-group horizontal>
  <b-list-group-item><div id="pochmann2"></div></b-list-group-item>
  <b-list-group-item>R U' R' U' R U R' F' R U R' U' R' F R</b-list-group-item>
</b-list-group>
...
<h3>発展</h3>
<p>上ではY-Permを基本としましたが、UBとULのエッジが交換され、ULBとどこかのコーナーが交換されるものであれば、Y-Permに限らず使うことができます。それは、J-Permです。</p>

<b-row>
  <b-col>Y-Perm</b-col>
  <b-col>J.a-Perm</b-col>
  <b-col>J.b-Perm</b-col>
</b-row>
<b-row>
  <b-col><div id="pochmann5"></div></b-col>
  <b-col><div id="pochmann6"></div></b-col>
  <b-col><div id="pochmann7"></div></b-col>
</b-row>
<p>
...
<b-list-group horizontal>
  <b-list-group-item><div id="pochmann8"></div></b-list-group-item>
  <b-list-group-item>R' U L' U2 R U' R' U2 L R U'</b-list-group-item>
</b-list-group>
<b-list-group horizontal>
  <b-list-group-item><div id="pochmann9"></div></b-list-group-item>
  <b-list-group-item>U2 R U R' F' R U R' U' R' F R2 U' R' U</b-list-group-item>
</b-list-group>

<h4>例3：スクランブル B D' R2 D L D' R2 D L' B'</h4>
<div id="pochmann10"></div>

<p>1回目：ULB → FURに移動します。基本に従ってRDFにセットアップするにはR2 D'ですが、RでURBにセットアップして、J.a-Permでも処理できます。</p>
<p>セットアップ → J.a-Perm → 逆セットアップ</p>
<p><b>R (R' U L' U2 R U' R' U2 L R U') R'</b></p>
<p>2回目：ULB → LDFに移動します。基本に従ってRDFにセットアップするにはD2 Rですが、FでULFにセットアップして、J.b-Permでも処理できます。</p>
